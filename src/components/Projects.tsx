...
const Projects = ()=>{
    return (
      <section className="section-container bg-black">
        <h2 className="text-center text-2xl mb-5 text-white m-10">
          My <span className="ml-2 font-extrabold text-2xl">Projects</span>
        </h2>
        <div className="flex justify-center flex-col gap-10 mb-10">
          {/* Project cards */}
          <div className="">
            <div className="mb-5">
              <Image
                alt="project-image"
                src={projectImage}
                className="w-96 h-96 object-cover bg-center rounded-md border border-red"
              />
            </div>

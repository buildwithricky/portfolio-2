...
const ExperienceSection = ()=>{
    return (
      <section className="section-container bg-secondary text-primary">
        <h2 className="text-center text-2xl mb-5 p-10">
          My <span className="ml-2 font-extrabold text-2xl">Experience</span>
        </h2>
        {/* Experience section */}
